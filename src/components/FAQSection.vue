...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Оптимальная частота - 2-4 тренировки в неделю. Это позволяет достичь результата без перетренированности и дает время на восстановление.',
    points: [
      'Новички: 2 тренировки в неделю',
      'Средний уровень: 2-3 тренировки в неделю',
      'Продвинутый уровень: 3-4 тренировок в неделю',
